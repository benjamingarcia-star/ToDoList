...
public class TelaLogin extends javax.swing.JFrame {
   ...
   private static final String Usuario = "Benjamin Florencio Garcia";
   private static final String Senha = "170311";
    /**
    ...
    private void initComponents() {
        ...
        jButtonEntrar.setFont(new java.awt.Font("RomanT", 1, 18)); // NOI18N
    ...
    private void jButtonEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEntrarActionPerformed
        if (jTextFieldUsuario.getText().equals(Usuario) && jPasswordFieldSenha.getText().equals(Senha)) {
            JOptionPane.showMessageDialog(null, "Usuário e Senha correta! O sistema será iniciado.");
            
            MinhaPrimeiraTelinha_PascalCase minhaPrimeiraTelinha = new MinhaPrimeiraTelinha_PascalCase();
