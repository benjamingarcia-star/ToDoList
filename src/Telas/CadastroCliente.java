...
public class CadastroCliente extends javax.swing.JFrame {
    ...
    private Boolean validacoes(){
        ...
        if (!jRadioButtonMasculino.isSelected() && !jRadioButtonFeminino.isSelected()){
            JOptionPane.showMessageDialog(null, "Opção de gênero não foi preenchido");
            return false;
        }
    ...
    private void initComponents() {
        ...
        jComboBoxCidade.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Campo Mourão", "Santa Catarina", "Araruna", "Cianorte", "Curitiba", "Maringá", "Mamborê", "Goioerê", "Londrina", "Foz do Iguaço", "Ubiratã" }));
